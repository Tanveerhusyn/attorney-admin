    ...
    <div className="flex flex-col justify-center items-center space-y-4">
      <Card className="w-full lg:min-w-[900px]">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-2xl font-bold">{city?.city}</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-row justify-between items-center">
          <div>
            ...
            <div id="pop" className="text-xl font-medium">
              {city?.population}
            </div>
          </div>
          ...
          <div>
            ...
            <div id="state" className="text-xl font-medium">
              {city?.state_name}
            </div>
          </div>
          <div>
            ...
            <div id="ranking" className="text-xl font-medium">
              {city?.ranking}
            </div>
          </div>
        </CardContent>
      ...
      <Tabs
        ...
        className=" w-full min-w-[400px] max-w-[1000px]"
      >
