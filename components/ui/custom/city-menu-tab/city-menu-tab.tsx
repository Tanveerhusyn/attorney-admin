...
export function CityMenuTabs({ city, id }: { id: string, city: object }) {
    return (
        <div className="flex flex-col justify-center items-center space-y-4">
            ...
            <Tabs defaultValue="profile" className=" w-full min-w-[400px] max-w-[1000px]">
                ...
                <TabsContent value="article">
                    <ArticleForm city={city} id={city?.id} />
                    {/* <QuillForm /> */}
                </TabsContent>

                <TabsContent value="attorneys">
                    <AttorneyForm city={city} id={city?.id} />
                </TabsContent>
                <TabsContent value="reviews">
                    <ReviewForm review={city} id={city?.id} />
                </TabsContent>
                <TabsContent value="faqs">
                    <FaqForm city={city} id={city?.id} />
                </TabsContent>
            </Tabs>
        </div>
